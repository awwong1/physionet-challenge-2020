...
def get_structured_lead_features(lead_signal, sampling_rate=500, lead_name=""):
    ...
    try:
        ...
        hb_data, hb_dtype = _extract_tsfresh_from_heartbeats(
...
def _extract_tsfresh_from_heartbeats(signals, rpeaks, sampling_rate, lead_name):
